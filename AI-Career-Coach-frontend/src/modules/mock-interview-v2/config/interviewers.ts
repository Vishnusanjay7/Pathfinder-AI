...
export const INTERVIEWER_PROFILES_CONFIG_V2: InterviewerProfileV2[] = [
  {
    id: "female_hr",
    name: "Priya Sharma",
  ...
  },
  {
    ...
    voice_preference: "en-US",
    office_setting: "Modern Corporate Innovation Suite with Architectural View",
    description: "Principal technical architect evaluating system design depth, technical trade-offs, scalability constraints, and clean engineering practices.",
    avatar_video_src: "/interviewer/speaking.mp4",
    avatar_thumbnail_src: "/avatars/meera_iyer.jpg",
  ...
  },
  {
    ...
    voice_preference: "en-US",
    office_setting: "Corporate Executive Engineering Office with Modern Workstation",
    ...
    avatar_video_src: "/interviewer/speaking.mp4",
    avatar_thumbnail_src: "/avatars/rohan_verma.jpg",
...
export function getInterviewerProfileByIdV2(id?: string): InterviewerProfileV2 {
  const found = INTERVIEWER_PROFILES_CONFIG_V2.find((p) => p.id === id);
  return found || INTERVIEWER_PROFILES_CONFIG_V2[0];
}
