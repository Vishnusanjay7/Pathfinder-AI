...
async def test_long_synthesis():
    text = (
        "Could you please walk me through a complex architectural project where you designed "
        "and implemented distributed microservices, highlighting the specific scalability challenges "
        "you faced, how you handled inter-service communication, and the ultimate business outcome?"
    )
    print(f"[TEST] Synthesizing Long Question Deepgram TTS for: '{text[:60]}...'")
    ...
    print("[TEST] Running AI Video Lip-Sync Engine on extended audio...")
    ...
    print("\n[SUCCESS] Long Question Lip-Sync Pipeline validated successfully!")

if __name__ == "__main__":
    asyncio.run(test_long_synthesis())
